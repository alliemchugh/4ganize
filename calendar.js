...
function fillEventSidebar(self) {
  ...
  var thisassignmnet = self.hasClass("event--assignment");
  var thistest = self.hasClass("event--test");
  var thisproject = self.hasClass("event--project");
  var thisother = self.hasClass("other");
